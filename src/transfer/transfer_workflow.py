...
def run_interactive():
    ...
    selected_uids, transfer_mode = interactive_select_keep(household_teis, child_teis, hh_to_children, child_to_hh)
    ...
    keep_set, transfer_set = resolve_transfer_set(
        selected_uids, all_teis, hh_to_children, child_to_hh, transfer_mode=transfer_mode
    )
